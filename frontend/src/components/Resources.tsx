...
export default function Resources() {
    return <div>
        <Section>
            ...
            <Paragraph>These are some links for some websites that may be useful if you are planning hikes or looking to develop your skills. As well as links to some of the Mountaineering Scotland benefits that are available to paid club members.</Paragraph>
            <List>
        ...
        <Section>
            ...
            <List>
                <ListItem>
                    <Link href="https://docs.google.com/document/d/1Ftu1yT_CSvXUpaRQEE1qAgLCHp597jV1/edit?usp=sharing&ouid=111040657907103847525&rtpof=true&sd=true" title="AGM Minutes 2023" target="_blank" rel="noreferrer">AGM 2023 Minutes</Link>
                </ListItem>
                <ListItem>
                    <Link href="https://docs.google.com/document/d/1pq1_LWzoijFINMSAZTOt0IIS6_NR6RUDHC7XsjzNGMY/edit?usp=sharing" title="EGM Minutes 2023" target="_blank" rel="noreferrer">EGM 2023 Minutes</Link>
                </ListItem>
            </List>
        </Section>
    </div>
