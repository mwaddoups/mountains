...
export const FormInput = tw.input`font-light px-2 py-1 shadow border rounded w-full leading-tight focus:shadow-lg mb-4`;
export const FormTextArea = tw.textarea`font-light text-sm px-2 py-1 shadow border rounded w-full leading-tight focus:shadow-lg mb-4 resize-none`;
...
export const SmallRedButton = tw.button`px-1 py-0.5 rounded-lg bg-red-400 text-sm text-gray-100 hover:bg-red-600`;
export const SmallCancelButton = tw.button`px-1 py-0.5 rounded-lg bg-gray-300 text-sm text-gray-700 hover:bg-gray-400`;
...
export const colorVariants: Record<BadgeColor, any> = {
  ...
  yellow: tw`bg-yellow-500 text-gray-100`,
